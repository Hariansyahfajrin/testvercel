...
class BrandProvider extends ChangeNotifier {
  ...
  deleteBrand(Brand brand) async {
    try {
      // Mengirim permintaan untuk menghapus brand
      ...
      if (response.isOk) {
        ...
        if (apiResponse.success == true) {
          ...
          _dataProvider
              .getAllBrands(); // Memperbarui daftar brand setelah penghapusan
        } else {
          SnackBarHelper.showErrorSnackBar(
