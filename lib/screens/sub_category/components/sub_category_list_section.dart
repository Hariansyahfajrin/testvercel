...
DataRow subCategoryDataRow(SubCategory subCatInfo, int index,
  ...
  // Format the date
  final formattedDate = subCatInfo.createdAt != null
      ? DateFormat('yyyy-MM-dd').format(DateTime.parse(subCatInfo.createdAt!))
      : '';
  ...
  return DataRow(
    cells: [
      ...
      DataCell(Text(formattedDate)), // Use formatted date
      DataCell(IconButton(
          onPressed: () {
            if (edit != null) edit();
          },
