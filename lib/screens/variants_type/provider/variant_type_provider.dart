...
class VariantsTypeProvider extends ChangeNotifier {
    ...
    try {
      ...
      if (response.isOk) {
        ...
        if (apiResponse.success == true) {
          ...
          print('Variant Type added'); // Ganti Log dengan print
      ...
      if (variantTypeForUpdate != null) {
        ...
        if (response.isOk) {
          ...
          if (apiResponse.success == true) {
            clearFields();
            SnackBarHelper.showSuccessSnackBar('${apiResponse.message}');
            print('Variant Type Updated'); // Ganti Log dengan print
            _dataProvider.getAllVariantTypes();
          } else {
            SnackBarHelper.showErrorSnackBar(
        ...
        SnackBarHelper.showErrorSnackBar(
            'Variant Type for update is not specified.');
      }
    } catch (e) {
      print(e);
      SnackBarHelper.showErrorSnackBar('An error occurred: $e');
  ...
  Future<void> deleteVariantType(VariantType variantType) async {
    try {
      // Menghapus tipe varian menggunakan API
