...
class VariantsProvider extends ChangeNotifier {
  ...
  addVariant() async {
    try {
      // Membuat map untuk data varian
      Map<String, dynamic> variant = {
        'name': variantCtrl.text,
        'variantTypeId': selectedVariantType?.sId
      };

      // Mengirim permintaan untuk menambahkan varian menggunakan API
  ...
  updateVariant() async {
    try {
      // Memeriksa apakah variantForUpdate tidak null
      if (variantForUpdate != null) {
        // Membuat map untuk data varian yang diperbarui
        Map<String, dynamic> variant = {
          'name': variantCtrl.text,
          'variantTypeId': selectedVariantType?.sId
        };

        // Mengirim permintaan untuk memperbarui varian menggunakan API
  ...
  deleteVariant(Variant variant) async {
    try {
      // Mengirim permintaan untuk menghapus varian menggunakan API
